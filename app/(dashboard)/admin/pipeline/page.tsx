...
export default async function AdminPipelinePage() {
  ...
  const { data: deals } = await supabase
    .from('deals')
    .select('id,business_name,owner_name,current_stage,owner_profile:owner_profile_id(full_name),assigned_rep:assigned_rep_id(full_name)')
