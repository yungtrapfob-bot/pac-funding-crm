...
export default async function RepDashboardPage() {
  ...
  let leadsQuery = supabase.from('hot_leads').select('id,business_name,owner_name,phone,email,follow_up_status,next_follow_up_date').not('next_follow_up_date', 'is', null).order('next_follow_up_date', { ascending: true }).limit(8);
