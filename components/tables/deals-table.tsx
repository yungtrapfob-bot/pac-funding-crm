      ...
      <table className="w-full min-w-[640px] text-sm">
        <thead className="bg-muted/35 text-left">
          <tr>
            ...
            <th className="p-2">Assigned Rep</th>
        ...
        <tbody>
          {deals.map((deal) => (
            <tr key={deal.id} className="border-t border-border/80 hover:bg-muted/20">
              <td className="p-2">
              ...
              <td className="p-2">{deal.assigned_rep?.full_name ?? 'Unassigned'}</td>
              <td className="p-2">
