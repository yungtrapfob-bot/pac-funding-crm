...
values
('Northside Roofing', 'Carl Bishop', '404-555-9821', 'carl@northside.com', 'Construction', 140000, 62, 'GA', 1, 1, 72, 645, 'Fast close requested', 'Collect final COI', 'Contracts Out', (select id from eric), null, null, 0, 0, 0),
...
('Metro Bodega', 'Luis Chen', '718-555-7712', 'luis@metrobodega.com', 'Retail', 78000, 22, 'NY', 3, 3, 44, 603, 'Volatile deposits', 'Likely decline', 'KIF', (select id from vlad), null, null, 0, 0, 0);
